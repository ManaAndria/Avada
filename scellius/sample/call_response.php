...
<?php
   ...
   $pathfile="pathfile=/var/www/html/scellius_617_PLUGIN_linux64-2.6.18/param/pathfile";
	...
	$path_bin = "/var/www/html/scellius_617_PLUGIN_linux64-2.6.18/bin/glibc-2.5-42/response";
  ...
  if (( $code == "" ) && ( $error == "" ) )
	...
	print("<center>\n");
	print("<H3>R&eacute;ponse manuelle du serveur SCELLIUS</H3>\n");
	print("</center>\n");
	print("<b><h4>\n");
	print("<br><hr>\n");
