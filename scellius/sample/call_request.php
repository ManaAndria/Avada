...
<!--	Affichage du header html	-->
 <?php
	...
	print ("<HTML><HEAD><TITLE>SCELLIUS - Paiement Securise sur Internet</TITLE></HEAD>");
	print ("<BODY bgcolor=#ffffff>");
	print ("<Font color=#000000>");
	print ("<center><H1>Test de l'API plug-in SCELLIUS</H1></center><br><br>");


	//		Affectation des paramètres obligatoires

	$parm="merchant_id=082053530000017";
	...
	$parm="$parm pathfile=/var/www/html/scellius_617_PLUGIN_linux64-2.6.18/param/pathfile";
	...
	$parm="$parm cancel_return_url=http://localhost/scellius_617_PLUGIN_linux64-2.6.18/sample/call_response.php";

	//		$parm="$parm automatic_response_url=http://www.maboutique.fr/cgi-bin/call_autoresponse.php";
	$parm="$parm automatic_response_url=http://localhost/scellius_617_PLUGIN_linux64-2.6.18/sample/call_autoresponse.php";
	...
	$path_bin = "/var/www/html/scellius_617_PLUGIN_linux64-2.6.18/bin/glibc-2.5-42/request";
