...
<?php
$custom_message = 'Customer firstname : '.$_POST['first-name'].'<br />';
$custom_message .= "Customer name : ".$_POST['your-name']."<br />";
$custom_message .= "Customer title : ".$_POST['Title']."<br />";
$custom_message .= "Customer Payment option : ".$_POST['Paymentoption']."<br />";
$custom_message .= "Customer email : ".$_POST['your-email']."<br />";
$custom_message .= "Customer Laboratory / Institution / Press : ".$_POST['laboratory-institution-press']."<br />";
$custom_message .= "Customer Phone : ".$_POST['Phone']."<br />";
$custom_message .= "Customer Postal Address : ".$_POST['postal-address']."<br />";
$custom_message .= "Customer Country : ".$_POST['country']."<br />";
$custom_message= ereg_replace("^[ ]", "&nbsp;", $custom_message); 
$custom_message= str_replace("\n ", "\n&nbsp;", $custom_message); 
$custom_message= str_replace(" ", "&nbsp;", $custom_message);
// echo "<textarea>".$custom_message."</textarea>";
// exit();
//		Affectation des paramètres obligatoires

	$parm="merchant_id=014141675911111";
	...
	$parm="$parm pathfile=/var/www/vhosts/hwwc.mg/param/pathfile";
	...
	//
	 		$parm="$parm normal_return_url=".site_url();
			$parm="$parm cancel_return_url=".site_url();
			$parm="$parm automatic_response_url=".get_permalink(25);
			...
			// $parm="$parm textcolor=";
			// $parm="$parm receipt_complement=".$custom_message;
			$parm="$parm caddie=".$custom_message;
			//$parm="$parm customer_id=";
			$parm="$parm customer_email=".$_POST['your-email'];
			...
			//$parm="$parm customer_name=ARETMIC";
			//$parm="$parm customer_first_name=".$_POST['first-name'];
			//$parm="$parm customer_birthdate=";
			$parm="$parm customer_phone=".$_POST['Phone'];
	...
	$path_bin = "/var/www/vhosts/hwwc/bin/glibc-2.5-42/request";
