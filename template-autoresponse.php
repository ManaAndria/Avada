<?php
/**
 * Template Name: AutoResponse Page
 */
...
// Récupération de la variable cryptée DATA
	...
	$pathfile="pathfile=/var/www/vhosts/hwwc.mg/param/pathfile";
	...
	$path_bin = "/var/www/vhosts/hwwc.mg/bin/glibc-2.5-42/response";
	...
	$logfile="/var/www/vhosts/hwwc.mg/logfile.txt";
...
$final_message = $start_message.$message_mail.$end_message;
	...
	wp_mail('directeur.informatique@netunivers.com', $custom_subject, $final_message, $headers);
